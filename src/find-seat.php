            ...
            while ($seatsCounted <= $numCols && !$seatAssigned) {
                ...
                if (!$checkMiddleSeat) {
                    ...
                    if ($status) {
                        ...
                        $midright = $mid + $nextSeat;
                        $midleft = $mid - $nextSeat;
...
function processTwoSeatRequest($row, $col)
{
    ...
    if ($status) {
        ...
        $midright = $col + $nextSeat;
        $midleft = $col - $nextSeat;
